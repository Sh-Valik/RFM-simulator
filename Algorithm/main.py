...
def run_simulation(data):
    ...
    if input_mode == "Start mass & Propellant":
        ...
        if has_boosters:
            ...
            Ve_boosters, mass_flow_boosters, m0_each_boosters, m_construction_each_boosters, m_prop_each_boosters, m0 = parameters_of_boosters(input_mode, booster_data_list, m_payload_without_boosters, m_payload_with_boosters, Vf_id_stages, m0_stages, m_prop_stages, stages_count, booster_count, Ve_stages, mass_flow_stages, t_burn_ratio)
    ...
    return {
        "Ve_boosters": Ve_boosters,
        "mass_flow_boosters": mass_flow_boosters,
        "m0_each_boosters": m0_each_boosters,
